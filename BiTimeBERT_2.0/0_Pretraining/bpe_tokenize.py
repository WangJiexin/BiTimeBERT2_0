...
def get_chunks(fpath, chunk_size):
    ...
    for line in f:
        ...
        if len(chunk) == chunk_size:
            yield chunk
            #looks like ['[PAD] 35000', '', '[unused1] 34999', '[unused2] 34998', '[unused3] 34997', '', '[unused4] 34996', '[unused5] 34995', '', '[unused6] 34994'...
            #'' denotes another document
            chunk = []
    yield chunk
...
def process(cased_file, output_file, bert_model_type='bert-base-cased', total=180378072, chunk_size=1000000, workers=40):
    ...
    for cased_lines in tqdm(get_chunks(cased_file, chunk_size), total=total//chunk_size):
        #假设cased_lines包含的是chunk_size个句子->cased_file里的格式是一个句子一行
        #like ['[PAD] 35000', '', '[unused1] 34999', '[unused2] 34998', '[unused3] 34997', '', '[unused4] 34996', '[unused5] 34995', '', '[unused6] 34994'...
        #'' denotes another document
